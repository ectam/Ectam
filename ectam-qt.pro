...
contains(ECTAM_NEED_QT_PLUGINS, 1) {
    DEFINES += ECTAM_NEED_QT_PLUGINS
...
HEADERS += src/qt/Ectamgui.h \
    ...
    src/qt/Ectamaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/Ectam.cpp src/qt/Ectamgui.cpp \
    ...
    src/qt/Ectamaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/Ectamstrings.cpp \
    src/qt/Ectamamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
...
# also add new translations to src/qt/Ectam.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/Ectam_*.ts)
...
OTHER_FILES += \
    doc/*.rst doc/*.txt doc/README README.md res/Ectam-qt.rc
...
windows:RC_FILE = src/qt/res/Ectam-qt.rc
...
macx:ICON = src/qt/res/icons/Ectam.icns
macx:TARGET = "Ectam-Qt"
