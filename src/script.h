...
#ifndef H_ECTAM_SCRIPT
#define H_ECTAM_SCRIPT
 ...
 *  A CTxDestination is the internal data type encoded in a CEctamAddress
 */
...
public:
    ...
    // Pre-version-0.6, Ectam always counted CHECKMULTISIGs
